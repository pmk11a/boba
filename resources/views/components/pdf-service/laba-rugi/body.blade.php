        ...
        @forelse ($data as $key => $item)
            ...
            @else
                <tr style="border-top: none; border-bottom: none;">
                    ...
                    <td style="border-top: none; border-bottom: none;" class="text-left align-middle">
                        {{ $item->keterangan }}</td>
                    <td style="border-top: none; border-bottom: none;" class="text-right align-middle">
                        {{ number_format(floatval($item->TotalA), 2) }}</td>
                    <td style="border-top: none; border-bottom: none;" class="text-right align-middle">
                        {{ number_format(floatval($item->TotalB), 2) }}</td>
                    <td style="border-top: none; border-bottom: none;" class="text-right align-middle">
                        {{ number_format(floatval($item->TotalC), 2) }}</td>
                </tr>
            @endif
        @empty
        @endforelse
